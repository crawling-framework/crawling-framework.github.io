...
from models import truncated_power_law, configuration_model, truncated_normal
...
def test_assort_config_model():
    n = 2000
    # deg_seq = truncated_power_law(n, gamma=1.6, maximal=n)
    ...
    graph = assort_conf_model_MH(deg_seq, e_jk_func, directed=False)
