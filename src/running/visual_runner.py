...
from running.metrics_and_runner import CrawlerRunner, Metric
...
class CrawlerVisualRunner(CrawlerRunner):
    ...
    """
    def __init__(self, crawler_def, metric_def,
                 draw_mode=None, steps_per_pic=1, layout_pos=None):
        """
        ...
        :param steps_per_pic: save picture every batches_per_pic batches. more -> faster
        :param layout_pos:
        :return:
        """
        raise NotImplementedError()
        super().__init__(crawler_defs=[crawler_def], metric_defs=[metric_def])
    ...
    def run(self, graph: MyGraph, same_initial_seed=False, draw_networkx=False):
        ...
        while i < self.budget:
            ...
            for crawler in crawlers:
                ...
                for metric in metrics:
                    ...
                    if draw_networkx and (i % self.steps_per_pic == 0):
